 ...
 *
 *     $ php bin/console rh:user:add
 *
 * To output detailed information, increase the command verbosity:
 *
 *     $ php bin/console rh:user:add -vv
 *
...
{
    protected static $defaultName = 'rh:user:add';
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->io->text([
            ...
            '',
            ' $ php bin/console rh:user:add username password email@example.com',
            '',
